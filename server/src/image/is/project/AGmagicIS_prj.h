// AGmagicIS.h : main header file for the AGmagicIS DLL
//

#if !defined(AGMAGICIS_PRJ_H__41BDB14B_1199_4C39_BBDE_8F230685FC7B__INCLUDED_)
#define AGMAGICIS_PRJ_H__41BDB14B_1199_4C39_BBDE_8F230685FC7B__INCLUDED_
...
#define	AGMAGICIS_LIBRARY_SERIAL_KEY		_T("")
...
/////////////////////////////////////////////////////////////////////////////
// CAGmagicISDllApp
// See AGmagicIS.cpp for the implementation of this class
//

class CAGmagicISDllApp : public CWinApp
{
public:
	CAGmagicISDllApp();
...
// Overrides
	...
	//{{AFX_VIRTUAL(CAGmagicISDllApp)
	//}}AFX_VIRTUAL

	//{{AFX_MSG(CAGmagicISDllApp)
...
#endif // !defined(AGMAGICIS_PRJ_H__41BDB14B_1199_4C39_BBDE_8F230685FC7B__INCLUDED_)
