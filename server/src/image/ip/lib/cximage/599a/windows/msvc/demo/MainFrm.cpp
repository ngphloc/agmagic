...
void CMainFrame::OnClose() 
{
    ...
    AfxGetApp()->WriteProfileString( "TextTool", "lfFaceName", pTheApp->m_text.lfont.lfFaceName );
	AfxGetApp()->WriteProfileInt( "TextTool", "lfCharSet", pTheApp->m_text.lfont.lfCharSet );
	AfxGetApp()->WriteProfileInt( "TextTool", "lfWeight", pTheApp->m_text.lfont.lfWeight );
	AfxGetApp()->WriteProfileInt( "TextTool", "lfItalic", pTheApp->m_text.lfont.lfItalic );
	AfxGetApp()->WriteProfileInt( "TextTool", "lfUnderline", pTheApp->m_text.lfont.lfUnderline );
	AfxGetApp()->WriteProfileInt( "TextTool", "fcolor", pTheApp->m_text.fcolor );
	AfxGetApp()->WriteProfileInt( "TextTool", "bcolor", pTheApp->m_text.bcolor );
	AfxGetApp()->WriteProfileInt( "TextTool", "opacity", (int)(100.*pTheApp->m_text.b_opacity) );
	AfxGetApp()->WriteProfileInt( "TextTool", "r_radius", pTheApp->m_text.b_round );
	AfxGetApp()->WriteProfileInt( "Options" , "JpegQuality",pTheApp->m_optJpegQuality);
