...
class AGMAGIC_DECL CSCBDockBar : public CDockBar
{
...
class AGMAGIC_DECL CSizingControlBar : public baseCSizingControlBar
{
...
class AGMAGIC_DECL CSCBDockContext : public CDockContext
{
public:
// Construction
...
class AGMAGIC_DECL CSCBMiniDockFrameWnd : public baseCSCBMiniDockFrameWnd
{
