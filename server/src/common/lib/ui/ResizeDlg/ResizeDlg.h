...
enum AGMAGIC_DECL { m_idSizeIcon = IDC_DLGSIZEBOX };
enum AGMAGIC_DECL {				// possible Control reSize Type
	CST_NONE = 0,
...
class AGMAGIC_DECL CResizeDlg : public CDialog
{
