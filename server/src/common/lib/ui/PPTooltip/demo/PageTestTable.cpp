...
BOOL CPageTestTable::OnInitDialog() 
{
	...
	m_tooltip.AddTool(GetDlgItem(IDC_BUTTON6), _T("<center><h2>Styles of the Table Borders</h2><br><hr color=blue></center><br>1) Border style = solid<table borderstyle=solid><tr><td> </td><td> </td></tr></table><br>2) Border style = dotted<table borderstyle=dotted><tr><td> </td><td> </td></tr></table><br>3) Border style = dashed<table borderstyle=dashed><tr><td> </td><td> </td></tr></table><br>4) Border style = double<table borderstyle=double><tr><td> </td><td> </td></tr></table>"));
	m_tooltip.AddTool(GetDlgItem(IDC_BUTTON4), _T("<center><h2>Colors in the Table</h2></center><br><hr color=blue><br>1) Red Border <table border=2 bordercolor=red><tr><td> </td><td> </td></tr></table><br>2) Lighten and Darken Border<table border=2 bordercolorlight=red bordercolordark=darkred><tr><td> </td><td> </td></tr></table>"));
