...
/*
#if ( (!defined _MBCS) || (defined _UNICODE) || (!defined _AFXDLL) || (defined __STATPROFUIS_WITH_DLLMFC__) || (!defined _DEBUG) || (defined NDEBUG) )
	#pragma message(" *** ")
	#pragma message(" *** ")
	#pragma message(" *** You can compile only Win32-MBCS Debug configuration of sample projects")
	#pragma message(" *** ")
	#pragma message(" *** ")
	#error "You can compile only Win32-MBCS Debug configuration of sample projects"
#endif
*/
