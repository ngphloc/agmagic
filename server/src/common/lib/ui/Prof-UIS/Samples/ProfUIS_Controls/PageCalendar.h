...
// Dialog Data
	...
	CSpinButtonCtrl	m_spinRowsMin;
	CSpinButtonCtrl	m_spinRowsMax;
	CSpinButtonCtrl	m_spinColumnsMin;
	CSpinButtonCtrl	m_spinColumnsMax;
	CExtFlatEdit	m_wndNotifications;
