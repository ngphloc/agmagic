...
public:
	...
	class CMyTabPageContainerWndFlat : public CExtTabPageContainerFlatWnd
	{
		...
		virtual CExtTabWnd* OnTabWndGetTabImpl(){
			return new CExtTabsWndImpl < CMyTabWndFlat >;
		}
...
protected:
	...
	CExtEdit m_wndEditCtrl0;
	CExtWFF<CTreeCtrl> m_wndTreeCtrl0;
	CExtResizableDialog m_wndTabPageDialog0;
	CExtFlatEdit m_wndEditInTabPageDlg0;
	CExtLabel m_wndLableInTabPageDlg0;
	
	CExtColorCtrl m_wndColorCtrl1;
	CListBox  m_wndListBox1;
	CExtEdit m_wndEditCtrl1;
	CExtWFF<CTreeCtrl> m_wndTreeCtrl1;
	CExtResizableDialog m_wndTabPageDialog1;
	CExtFlatEdit m_wndEditInTabPageDlg1;
	CExtLabel m_wndLableInTabPageDlg1;
