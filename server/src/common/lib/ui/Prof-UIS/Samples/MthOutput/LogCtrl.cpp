...
void CLogCtrl::OnTimer(UINT nIDEvent) 
{
...
#else
	_tcscpy( _cf.szFaceName, _T("Courier New") );
#endif
...
} arrDemoOutputLines[] =
{
	...
	{ false, RGB(128,0,128), _T("   Creating library ../Bin_600/ProfUIS225md.lib and object ../Bin_600/ProfUIS225md.exp\n") },
	{ false, RGB(0,0,0), _T("\n") },
	{ true,  RGB(0,128,0), _T("ProfUIS225md.dll - 0 error(s), 0 warning(s)\n") },
	{ false, RGB(0,0,0), _T("\n") },
	...
	{ false, RGB(0,0,0), _T("ExtStatusControlBar.cpp\n") },
	{ true,  RGB(128,128,0), _T("Linking...\n") },
	{ false, RGB(128,0,128), _T("   Creating library ../Bin_600/ProfUIS225m.lib and object ../Bin_600/ProfUIS225m.exp\n") },
	{ false, RGB(0,0,0), _T("\n") },
	{ true,  RGB(0,128,0), _T("ProfUIS225m.dll - 0 error(s), 0 warning(s)\n") },
	{ false, RGB(0,0,0), _T("\n") },
};
...
void CDemoEventSourceWnd::OnTimer(UINT nIDEvent) 
{
	if( nIDEvent == ID_TIMER_EVENT_SOURCE )
	{
		if( m_nDemoOutputLineIndex >=
				sizeof(arrDemoOutputLines)/sizeof(arrDemoOutputLines[0])
			)
			m_nDemoOutputLineIndex = 0;
		ASSERT( m_pWndLogCtrl != NULL );
		if(		m_pWndLogCtrl->GetSafeHwnd() == NULL
			|| (! ::IsWindow(m_pWndLogCtrl->GetSafeHwnd()) )
			)
		{
